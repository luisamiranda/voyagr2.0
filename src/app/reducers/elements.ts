...
const initialState = {
  ...
  export const setElementXY = (elementUpdate: any) => {
    return {
      type: 'SET_ELEMENT_XY',
  ...
  export const setElementZIndex = (element: any) => {
    return {
      type: 'SET_Z_INDEX',
      element
    }
  ...
  export const setSize = (elementUpdateSize: any) => {
    return {
      type: "SET_SIZE",
      elementUpdateSize,
    }
  ...
  export const createTextBox = (newTextBox: any) => {
    return {
  ...
  export const editText = (updatedText: any) => {
    return {
      type: 'EDIT_TEXT',
      updatedText,
    }
  ...
  export const editBackgroundColor = (elementUpdate: any) => {
    return {
  ...
  export const editTextColor = (elementUpdate: any) => {
    return {
  ...
  export const addAPhoto = (photo: any) => ({
    type: 'ADD_A_PHOTO',
    photo
  })
  
  export const deleteElement = (elementToDelete: any) => {
    return {
      type: 'DELETE_ELEMENT',
      elementToDelete,
    }
  ...
  export const addAVideo = (video: any) => ({
    type: "ADD_A_VIDEO",
    video
  })
